...
final class ProjectRepository
{
    ...
    public static function changeStatus(int $id, string $newStatus): void
    {
        Database::connection()
            ->prepare('UPDATE projects SET status = :status WHERE id = :id')
     ...
     * @return array<int, array<string, mixed>>
     */
    public static function ordersForProject(int $projectId): array
    {
        $stmt = Database::connection()->prepare(
            'SELECT * FROM orders WHERE project_id = :project_id'
        );
